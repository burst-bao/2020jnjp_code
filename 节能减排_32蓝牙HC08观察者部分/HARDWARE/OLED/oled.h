...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOD,GPIO_Pin_4)//SCL
#define OLED_SCLK_Set() GPIO_SetBits(GPIOD,GPIO_Pin_4)
...
#define OLED_CS_Clr()  GPIO_ResetBits(GPIOD,GPIO_Pin_5)//CS
#define OLED_CS_Set()  GPIO_SetBits(GPIOD,GPIO_Pin_5)
